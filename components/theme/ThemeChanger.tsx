...
const ThemeChanger = () => {
  ...
  return (
    <Menubar className="border-none">
      <MenubarMenu>
        <MenubarTrigger className="cursor-pointer rounded-md bg-none p-0 outline-none focus:outline-none">
          <div className="relative aspect-square w-[16px] md:w-[18px] lg:w-[20px]">
            <Image
              src={`/assets/icons/${
